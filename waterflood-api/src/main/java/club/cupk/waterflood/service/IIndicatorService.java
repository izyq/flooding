...
public interface IIndicatorService extends IService<Indicator>{
    ...
    /**查询用户实体类Vo*/    default IndicatorVo getOneVo(Long indicatorId) {
    ...
    /**查询实体类Vo列表*/    default List<IndicatorVo> listVo(Indicator indicator) {
    ...
    /**分页查询实体类Vo*/    default IPage<IndicatorVo> pageVo(IPage<Indicator> page, Indicator indicator) {
