...
//    IIndicatorService indicatorService = DubboBean.getDubboBean(IIndicatorService.class);
//    /**查询用户实体类Vo*/
//    default CustEvaluationVo getOneVo(Long evalId) {
...
//    }
//    /**查询实体类Vo列表*/
//    default List<CustEvaluationVo> listVo(CustEvaluation custEvaluation) {
...
//    }
//    /**分页查询实体类Vo*/
//    default IPage<CustEvaluationVo> pageVo(IPage<CustEvaluation> page, CustEvaluation custEvaluation) {
