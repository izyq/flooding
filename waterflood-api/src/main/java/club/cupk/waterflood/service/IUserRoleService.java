...
public interface IUserRoleService                extends IService<UserRole>    {
    IUserService userService = DubboBean.getDubboBean(IUserService.class);
    IRoleService roleService = DubboBean.getDubboBean(IRoleService.class);
    default UserVo getUserVo(Long userId) {
    ...
    default List<UserVo> listVo(User user) {
    ...
    default IPage<UserVo> pageVo(IPage<User> page, User user) {
    ...
    default RoleVo getRoleVo(Long roleId) {
